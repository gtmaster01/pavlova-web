                        ...
                        <div className="grid gap-4">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-700 mt-1"><span className="font-medium">Video 1: Úvod a vaše mise za krásou.</span> Představení konceptu well-age. Naučíte se klíčová bezpečnostní pravidla a anatomické zásady, aby byla masáž prováděna s maximálním respektem k vlastnímu tělu.</p>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-700 mt-1"><span className="font-medium">Video 2: Ranní rituál – probuzení bez otoků</span>. Aktivní ranní postelový rituál a kapilární gymnastika. Naučíte se aktivovat lymfatický systém ještě dříve, než vstanete z postele.</p>
                                    <p className="text-sm text-slate-500 mt-1 italic">Výsledek: Okamžité odvedení ranních otoků a pocit lehkosti v celém těle.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-700 mt-1"><span className="font-medium">Video 3: Hlavní modelující masáž (základ)</span>. Hloubková práce s tkáněmi, uvolnění napětí v oblasti trapézů a šíje. Resetujeme svalové napětí, které je hlavní příčinou povadlých kontur.</p>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-700 mt-1"><span className="font-medium">Video 4: Modelace oválu a spodní třetiny</span>. Intenzivní práce na zpevnění a definici linie čelisti. Techniky pro eliminaci dvojité brady a vyhlazení marionetových vrásek.</p>
                                    <p className="text-sm text-slate-500 mt-1 italic">Výsledek: Ostře definované kontury a výrazný profil.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-700 mt-1"><span className="font-medium">Video 7: Uvolnění žvýkacích svalů a závěr</span>. Klíč k uvolněnému výrazu. Odstraňujeme hluboké bloky způsobené stresem a učíme se, jak rituály well-age udržet dlouhodobě.</p>
